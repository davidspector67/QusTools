...
"}")
    ...
    def retranslateUi(self, qusPage):
        ...
        self.utc2dButton.setText(QCoreApplication.translate("qusPage", u"2D Ultrasound Tissue Characterization (UTC) with RF Data", None))
#if QT_CONFIG(tooltip)
        self.utc3dButton.setToolTip(QCoreApplication.translate("qusPage", u"<html><head/><body><p><br/></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.utc3dButton.setText(QCoreApplication.translate("qusPage", u"2D Ultrasound Tissue Characterization (UTC) with IQ Data", None))
#if QT_CONFIG(tooltip)
